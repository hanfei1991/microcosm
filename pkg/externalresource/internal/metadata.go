...
func (m *MetadataAccessor) GetResource(ctx context.Context, resourceID model.ResourceID) (*model.ResourceMeta, bool, error) {
...
func (m *MetadataAccessor) DeleteResource(ctx context.Context, resourceID model.ResourceID) (bool, error) {
	key := adapter.ResourceKeyAdapter.Encode(resourceID)
...
) (records []*model.ResourceMeta, err error) {
