...
func NewConfig() *Config {
	...
	fs.StringVar(&cfg.FrameMetaConf.Endpoints[0], "frame-meta-endpoint", dorm.DefaultFrameMetaEndpoints, `framework metastore endpoint`)
	fs.StringVar(&cfg.FrameMetaConf.Auth.User, "frame-meta-user", dorm.DefaultFrameMetaUser, `framework metastore user`)
	fs.StringVar(&cfg.FrameMetaConf.Auth.Passwd, "frame-meta-password", dorm.DefaultFrameMetaPassword, `framework metastore password`)
	fs.StringVar(&cfg.UserMetaConf.Endpoints[0], "user-meta-endpoint", metaclient.DefaultUserMetaEndpoints, `user metastore endpoint`)
