...
func NewConfig() *Config {
	...
	fs.StringVar(&cfg.FrameMetaConf.User, "frame-meta-user", dorm.DefaultFrameMetaUser, `framework metastore user`)
	fs.StringVar(&cfg.FrameMetaConf.Password, "frame-meta-password", dorm.DefaultFrameMetaPassword, `framework metastore password`)
