...
var fileDescriptor_12d1cdcda51e000f = []byte{
	...
	,
}
...
// ResourceBrokerClient is the client API for ResourceBroker service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type ResourceBrokerClient interface {
	RemoveResource(ctx context.Context, in *RemoveResourceRequest, opts ...grpc.CallOption) (*RemoveResourceResponse, error)
}

type resourceBrokerClient struct {
	cc *grpc.ClientConn
}

func NewResourceBrokerClient(cc *grpc.ClientConn) ResourceBrokerClient {
	return &resourceBrokerClient{cc}
}

func (c *resourceBrokerClient) RemoveResource(ctx context.Context, in *RemoveResourceRequest, opts ...grpc.CallOption) (*RemoveResourceResponse, error) {
	out := new(RemoveResourceResponse)
	err := c.cc.Invoke(ctx, "/pb.ResourceBroker/RemoveResource", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// ResourceBrokerServer is the server API for ResourceBroker service.
type ResourceBrokerServer interface {
	RemoveResource(context.Context, *RemoveResourceRequest) (*RemoveResourceResponse, error)
}

// UnimplementedResourceBrokerServer can be embedded to have forward compatible implementations.
type UnimplementedResourceBrokerServer struct {
}

func (*UnimplementedResourceBrokerServer) RemoveResource(ctx context.Context, req *RemoveResourceRequest) (*RemoveResourceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RemoveResource not implemented")
}

func RegisterResourceBrokerServer(s *grpc.Server, srv ResourceBrokerServer) {
	s.RegisterService(&_ResourceBroker_serviceDesc, srv)
}

func _ResourceBroker_RemoveResource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RemoveResourceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ResourceBrokerServer).RemoveResource(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.ResourceBroker/RemoveResource",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ResourceBrokerServer).RemoveResource(ctx, req.(*RemoveResourceRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _ResourceBroker_serviceDesc = grpc.ServiceDesc{
	ServiceName: "pb.ResourceBroker",
	HandlerType: (*ResourceBrokerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "RemoveResource",
			Handler:    _ResourceBroker_RemoveResource_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "executor.proto",
